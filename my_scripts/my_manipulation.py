...
def _main(use_graphics=False):
    ...
    env = BathingEnv(graphics=use_graphics) # unity is started here
    #print(env.attrs)
    ...
    # print("robot local position")
    # print(robot.data["local_position"])
    # print("number of robot joints")
    # print(robot.data["number_of_joints"])
    # print("number of moveable robot joints")
    # print(robot.data["number_of_moveable_joints"])

    gripper = env.get_gripper()
    env.step()
    # print("gripper data")
    # print(gripper.data.keys())
    # print("gripper position")
    # print(gripper.data["position"])
    # print("gripper local position")
    # print(gripper.data["local_position"])
    ...
    # print("sponce data")
    # print(sponge.data)
    # print("sponce position")
    # print(sponge.data["position"])
    # print("sponce local position")
    # print(sponge.data["local_position"])
    ...
    position1 = (0.0, 0.0, 2.0)
    position2 = (0.0, 0.0, -0.5)
    # robot_pos= gripper.data["position"]
    robot.EnabledNativeIK(enabled=True)
    ...
    # robot.IKTargetDoMove(
    #     position=[robot_pos[0], robot_pos[1]-0.9, robot_pos[2]],
    #     duration=2,
    #     speed_based=False,
    #     relative=False
    # )
    ...
    # print("Obtain sponge data and simulate a step")
    # sponge = env.get_sponge()
    # env.step()
    # #print(sponge.data)

    # # Camera operations: Attach a camera to the robot's hand
    # print("Camera operations: Attach a camera to the robot's hand")
    # camera = env.get_camera()
    # camera.SetTransform(position=gripper.data['position'], rotation=[0, 0, 0])
    # camera.SetParent(2215820)
    # camera.GetRGB(512, 512)
    ...
    # print("Move the robot to some radom pisitions")
